...
<style>
  ...
  .separator#separator-1 {
    background: linear-gradient(
      25deg,
      var(--brand-dark) 0 40%,
      var(--brand-light) 40% 75%,
      var(--brand-dark) 75% 100%
    );
  }
...
<section id="download--install" class="columns">
  <div id="downloads" class="column">
    ...
    <div class="point">
      <select bind:value={downloadOptionId} id="downloads-launcher-chooser">
        {#each downloadOptions as option}
          <option value={option.id}>{option.name}</option>
        {/each}
      </select>
    </div>
    {#if downloadOptionId == 'vanilla'}
      <div class="point single-line">
        ...
        <span>
          <ExternalLink
            ...
            Download Fabric Installer (Windows)
          </ExternalLink>
        </span>
      </div>
      <div class="point single-line">
        ...
        <span>
          <ExternalLink
            ...
            Download Fabric Installer (Any OS)
          </ExternalLink>
        </span>
      </div>
      <div class="point single-line">
...
<section id="join-community">
  ...
  <a href="https://discord.gg/v6v4pMv">
    <img alt="Discord Logo" src="Discord-Logo-Color.png" />
  </a>
  <a href="https://github.com/FabricMC">
    <img alt="GitHub Logo" src="GitHub-Mark-64px.png" />
  </a>
</section>
...
<section class="columns" id="make-mods--blog">
  <div id="make-mods" class="column">
    ...
    <div>
      ...
      modders at
      <ExternalLink href="https://discord.gg/v6v4pMv">our Discord</ExternalLink>
      ready to help you if you struggle. But you need to start somewhere. Here's
    ...
    <div class="point">
      ...
      <span>
        Check out
        <ExternalLink href="https://fabricmc.net/wiki/tutorial:setup">
          this guide on our wiki
        </ExternalLink>
    ...
    <div class="point">
      ...
      <span>
        Try adding
        <ExternalLink href="https://fabricmc.net/wiki/tutorial:items">
          an item
        </ExternalLink>
        or
        <ExternalLink href="https://fabricmc.net/wiki/tutorial:blocks">
          a block.
        </ExternalLink>
        Both of the tutorials you can find on our wiki by the provided links.
      </span>
    </div>
    <div class="point">
      <div class="icon">3</div>
  ...
  <div id="blog" class="column">
    ...
    <ul>
      <li>
        <h3>
          <ExternalLink href="blog/538397-fabric-for-minecraft-1-16">
            Fabric for Minecraft 1.16
          </ExternalLink>
        </h3>
        <span>
      ...
      <li>
        <h3>
          <ExternalLink href="blog/134888-may-mods-highlight">
            May Mods Highlight
          </ExternalLink>
        </h3>
        <span>
      ...
      <li>
        <h3>
          <ExternalLink href="blog/249240-critical-changes-to-dimensions">
            Critical changes to dimensions
          </ExternalLink>
        </h3>
        <span>
